...
public class SignaturePropertyType implements Serializable
{
    ...
    public boolean equals(final Object o) {
        ...
        final SignaturePropertyType rhs = ((SignaturePropertyType) o);
        if (!EqualsHelper.equals(content, rhs.content)) {
            return false;
        }
        if (!EqualsHelper.equals(target, rhs.target)) {
            return false;
        }
    ...
    @Override
    public int hashCode() {
        return new HashCodeGenerator(this).append(content).append(target).append(id).getHashCode();
    }
    ...
    public String toString() {
        return new ToStringGenerator(this).append("content", content).append("target", target).append("id", id).toString();
    }
