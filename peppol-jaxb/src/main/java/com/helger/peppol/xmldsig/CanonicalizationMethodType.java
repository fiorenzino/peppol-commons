...
public class CanonicalizationMethodType implements Serializable
{
    ...
    public boolean equals(final Object o) {
        ...
        final CanonicalizationMethodType rhs = ((CanonicalizationMethodType) o);
        if (!EqualsHelper.equals(content, rhs.content)) {
            return false;
        }
        if (!EqualsHelper.equals(algorithm, rhs.algorithm)) {
            return false;
        }
        return true;
    }
    ...
    @Override
    public int hashCode() {
        return new HashCodeGenerator(this).append(content).append(algorithm).getHashCode();
    }
    ...
    public String toString() {
        return new ToStringGenerator(this).append("content", content).append("algorithm", algorithm).toString();
    }
