...
public class FaultType implements Serializable
{
    ...
    public boolean equals(final Object o) {
        ...
        final FaultType rhs = ((FaultType) o);
        if (!EqualsHelper.equals(faultMessage, rhs.faultMessage)) {
            return false;
        }
        return true;
    }
    ...
    @Override
    public int hashCode() {
        return new HashCodeGenerator(this).append(faultMessage).getHashCode();
    }
    ...
    public String toString() {
        return new ToStringGenerator(this).append("faultMessage", faultMessage).toString();
    }
