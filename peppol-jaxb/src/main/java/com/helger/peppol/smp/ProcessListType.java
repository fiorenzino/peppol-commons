...
public class ProcessListType implements Serializable
{
    ...
    public boolean equals(final Object o) {
        ...
        final ProcessListType rhs = ((ProcessListType) o);
        if (!EqualsHelper.equals(process, rhs.process)) {
            return false;
        }
        return true;
    }
    ...
    @Override
    public int hashCode() {
        return new HashCodeGenerator(this).append(process).getHashCode();
    }
    ...
    public String toString() {
        return new ToStringGenerator(this).append("process", process).toString();
    }
